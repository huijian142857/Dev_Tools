    ...
    public partial class SeeAssetBundleInfoWindow : EditorWindow
    {
        ...
        void OnGUI ()
        {
            ...
            if (string.IsNullOrEmpty(manifestPath))
            {
                ...
                manifestPath = "E:/zengfeng/GamePF/gamepf_art/_票房大王资源/Resources/zhouyou/StreamingAssets";
            }
            ...
            if (!string.IsNullOrEmpty(assetBundleName))
            {
                if (GUILayout.Button("查看资源"))
                {
                    ...
                    string assetBundlePath = "E:/zengfeng/GamePF/gamepf_art/_票房大王资源/Resources/zhouyou" + assetBundleName;
